...
<a href="{{ action('CartController@view') }}" class="text-center cart_items">
    <button class="relative text-2xl font-semibold text-white rounded-full"
        ...
        <span class="absolute text-center item_count text-cart text-dark left-8 top-5" style="padding-inline: 15px; padding-block:5px;  background-color: rgba(0, 0 ,0,.5); color: #fff; border-radius:40%; transform:translatey(-5px);  "
