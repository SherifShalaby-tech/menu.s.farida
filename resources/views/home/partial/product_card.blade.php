<div class="w-full mb-4">
    ...
    <div class="flex">
        <a href="{{ action('ProductController@show', $product->id) }}"
            class=" w-full text-white text-xs text-center   rounded-xl py-4 mt-2  bg-darkblue mx-auto  border-name-cat box-shadow-cat">
            ...
            <p class="md:text-sm xs:text-tiny font-semibold text-white py-0 flex-product-sb px-3">
                <button data-product_id="{{ $product->id }}" type="button"
                    ...
                    <i class="fa md:text-xl xs:text-sm fa-cart-plus cart_icon" style=" color: #2561c1;"></i>
                </button>
