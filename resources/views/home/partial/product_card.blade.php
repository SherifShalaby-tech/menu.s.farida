...
<div class="w-full mb-4 productCard" >
    ...
    <div class="flex">
        <div class="w-full py-4 mx-auto mt-2 text-xs text-center text-white rounded-xl bg-darkblue border-name-cat box-shadow-cat">
            ...
            <p class="py-0 font-semibold text-white md:text-sm xs:text-tiny">{{ Str::limit($product->name, 15) }}</p>
            </a>
            <p class="px-3 py-0 font-semibold text-white md:text-sm xs:text-tiny sm:flex sm:justify-between" style="align-content: center; align-items: center;">
